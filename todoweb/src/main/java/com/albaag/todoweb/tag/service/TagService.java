...
import com.albaag.todoweb.tag.model.Tag;
import com.albaag.todoweb.tag.model.TagRepository;
...
public class TagService {
    ...
    /*
        Esta función recibe una lista de tags como String, y para cada uno de ellos:
